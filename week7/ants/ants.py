...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        check_place, attack_range = self.place, 0 #save the start place of ant 
        while check_place != hive:
            if random_or_none(check_place.bees) != None and attack_range >= self.min_range and attack_range <= self.max_range:
                return random_or_none(check_place.bees)
            check_place , attack_range = check_place.entrance, attack_range+1        
...
# iterate over a list may change the contents of the list        
"""
slicing the list will create a new list
hense list[:] is like copying the list (equal to list.copy())
"""
        # END Problem 5
